...
public class BoringSSLClientSecureSocketProvider implements ClientSecureSocketProvider {

    public BoringSSLClientSecureSocketProvider() {
    }
    ...
    public String[] protocols(HttpAddress httpAddress) {
        // kill SSLv2Hello, disable TLS 1.3 on old OpenSSL
