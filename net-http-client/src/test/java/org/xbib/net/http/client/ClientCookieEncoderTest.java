...
class ClientCookieEncoderTest {
    ...
    void testEncodingMultipleClientCookies() {
        ...
        String encodedCookie = CookieEncoder.STRICT.encode(cookie1, cookie2, cookie3);
    ...
    void testWrappedCookieValue() {
        CookieEncoder.STRICT.encode(new DefaultCookie("myCookie", "\"foo\""));
    }

    @Test
    void testRejectCookieValueWithSemicolon() {
        assertThrows(IllegalArgumentException.class, () ->
                CookieEncoder.STRICT.encode(new DefaultCookie("myCookie", "foo;bar")));
    }
}
